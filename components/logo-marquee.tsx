...
const logos = [
	{ name: 'Класифікація слів', width: 100 },
	{ name: "Семантичні зв'язки", width: 80 },
	{ name: 'Гіперонімія', width: 90 },
	{ name: 'Гіпонімія', width: 100 },
	{ name: 'Візуалізація категорій', width: 70 },
	{ name: 'Next.js', width: 90 },
	{ name: 'AI Engine', width: 100 },
	{ name: 'Shadcn UI', width: 90 }
]
		...
		>
			...
			>
				<p className="text-sm text-zinc-500 uppercase tracking-wider font-medium">
					Технологічний стек та особливості
				</p>
			</motion.div>
			...
			<div className="relative">
				...
				<div className="flex animate-marquee">
					{[...logos, ...logos].map((logo, index) => (
						<div
							key={index}
							className="flex items-center justify-center min-w-40 h-16 mx-8 grayscale opacity-50 hover:grayscale-0 hover:opacity-100 transition-all duration-300"
						>
